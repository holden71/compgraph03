...
def image_building (txtname, imagename, size = (960,540)): # Создание преобразованного изображения
...
def main_menu():
    ...
    size = image_building(dataset_name, image_name) #создание картинки и возврат размера
